<x-layout>
    ...
    {{-- HERO --}}
    <section class="relative min-h-[70vh] flex items-center overflow-hidden border-b border-white/10 bg-primary text-white">
        <div class="absolute inset-0">
            ...
            {{-- Overlay de marque pour conserver la lisibilité --}}
            <div class="absolute inset-0 bg-primary/55"></div>
            <div class="absolute inset-0 bg-gradient-to-b from-primary/35 via-primary/60 to-primary-dark/95"></div>
        </div>
        ...
        <div class="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 lg:py-32 text-center">
            <span class="inline-flex items-center rounded-full border border-white/20 bg-white/10 px-4 py-2 text-[11px] sm:text-xs font-bold uppercase tracking-[0.24em] text-white/80 backdrop-blur-sm mb-6">
                <span class="mr-2 h-2 w-2 rounded-full bg-red"></span>
    ...
    {{-- VISION / MISSION --}}
    <section class="relative overflow-hidden border-y border-white/10 bg-primary text-white">
        <div class="absolute inset-0 pointer-events-none">
            <div class="absolute inset-0 bg-gradient-to-br from-primary via-primary to-primary-dark"></div>
            <div class="absolute top-0 right-0 h-80 w-80 rounded-full bg-bordeaux/25 blur-3xl"></div>
            <div class="absolute bottom-0 left-0 h-64 w-64 rounded-full bg-white/5 blur-3xl"></div>
            <div class="absolute inset-0 opacity-[0.06] bg-[linear-gradient(rgba(255,255,255,0.22)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.22)_1px,transparent_1px)] bg-[size:64px_64px]"></div>
        </div>

        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28">
            <div class="grid lg:grid-cols-12 gap-10 lg:gap-16 items-start">
                <div class="lg:col-span-4">
                    <span class="text-xs font-bold uppercase tracking-[0.24em] text-red block mb-4">
                    ...
                    <p class="mt-6 text-sm sm:text-base lg:text-lg leading-relaxed text-white/70 max-w-md">
                ...
                <div class="lg:col-span-8 grid md:grid-cols-2 gap-6 lg:gap-8">
                    <article class="rounded-[28px] border border-white/15 bg-white/[0.06] p-7 sm:p-10 backdrop-blur-sm transition duration-300 hover:bg-white/[0.10]">
                        ...
                        <p class="mt-5 text-white/75 text-sm sm:text-base leading-relaxed max-w-2xl">
                ...
                <div class="xl:col-span-8">
                    <div class="grid md:grid-cols-2 gap-5 sm:gap-6">
                        ...
                        <article class="group relative overflow-hidden rounded-[28px] border border-primary/10 bg-white p-6 sm:p-8 shadow-[0_10px_28px_rgba(6,27,79,0.05)] transition-all duration-300 hover:-translate-y-1 hover:border-primary/20 hover:shadow-[0_18px_36px_rgba(6,27,79,0.12)]">
                            ...
                            <div class="flex h-12 w-12 items-center justify-center rounded-2xl border border-primary/10 bg-primary/[0.05] text-primary">
